...
<template>
  <main class="flex flex-row h-screen bg-slate-800 text-white">
    <!-- Rotate warning overlay -->
    <div
      v-if="!isLandscape"
      id="rotate-warning"
      class="text-xl flex flex-col fixed inset-0 bg-slate-200 text-white items-center justify-center"
    >
